...
scaler_X = torch.load("models_AME/scaler_X.pth", weights_only=False)
scaler_y = torch.load("models_AME/scaler_y.pth", weights_only=False)
...
model.load_state_dict(torch.load("models_AME\struct_pruned_finetuned.pth"))  # or Struct_Prune.pth
model.eval()
