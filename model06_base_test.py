...
if __name__ == '__main__':
    ...
    model06_base = CNN6().to(device)
    model06_base.load_state_dict(torch.load("model06_base_cifar_trained.pth", map_location=device))
    model06_base.eval() 
    ...
    test_model(model06_base, testloader)
